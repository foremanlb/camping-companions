...
export default function Home() {
  return (
    <div id='home'>
      ...
      <img src='https://github.com/foremanlb/camping-companions/blob/master/client/src/images/css/Home.jpeg?raw=true' alt='Campers' id='main_photo'></img>
      ...
      If you get lost, you can click the campfire to find your way back to basecamp (home).  If you're logged in you can check your backpack to see your profile for your posts and campsites, or you can use the compass to leave camp and logout.<br/><br/>
