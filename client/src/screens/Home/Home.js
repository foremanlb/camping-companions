...
export default function Home() {
  return (
    <div id='home'>
      ...
      <h3>Camping is more fun with Companions!</h3>
      <p id='welcome_message'>Welcome to Camping Companions.  We are dedicated to the world of campers and helping them to come together.  We have compiled a collection of different campsites across the country, in the hopes of bringing campers together.<br/>
      You can view campsites based on state in the menu on the left.  Once you find a campsite that interests you, feel free to make a post sharing some details about when you would like to plan a trip, what you are hoping to do while camping, and an easy way for you to be contacted.  You can also save campsites to your favorites to make them easier to find in the future.<br />
